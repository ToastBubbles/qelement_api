...
export class AppModule implements NestModule {
  configure(consumer: MiddlewareConsumer) {
    ...
    consumer.apply(TrustedMiddleware).forRoutes(
      ...
      { path: 'color/edit/(.*)', method: RequestMethod.POST },
    ...
    consumer.apply(UserMiddleware).forRoutes(
      ...
      { path: 'message/getOneById/(.*)', method: RequestMethod.GET },
      { path: 'message/getAllById/(.*)', method: RequestMethod.GET },
      { path: 'message/getUnreadCountById/(.*)', method: RequestMethod.GET },
      { path: 'message/send', method: RequestMethod.POST },
      { path: 'message/delete/(.*)', method: RequestMethod.POST },
      { path: 'message/read/(.*)', method: RequestMethod.POST },
      ...
      { path: 'rating/getMyRating/(.*)', method: RequestMethod.GET },
      { path: 'rating/addRating', method: RequestMethod.POST },
      {
        path: 'sculpture/byIdWithPendingParts/(.*)',
        method: RequestMethod.GET,
      },
      { path: 'sculpture/add', method: RequestMethod.POST },
      { path: 'sculptureInventory/addParts/(.*)', method: RequestMethod.POST },
      { path: 'similarColor/add', method: RequestMethod.POST },
      { path: 'user/getQuestions/(.*)', method: RequestMethod.GET },
      { path: 'user/checkIfAdmin/(.*)', method: RequestMethod.GET },
      { path: 'userFavorite/id/(.*)', method: RequestMethod.GET },
      { path: 'userFavorite/add', method: RequestMethod.POST },
      { path: 'userFavorite/remove', method: RequestMethod.POST },
      { path: 'userGoal/id/(.*)', method: RequestMethod.GET },
      { path: 'userGoal/add', method: RequestMethod.POST },
      { path: 'userInventory/id/(.*)', method: RequestMethod.GET },
